      ...
      <form onSubmit={handleEmailLogin} className="space-y-5 sm:space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="mt-1 block w-full px-3 sm:px-4 py-2.5 text-sm sm:text-base border border-gray-300 rounded-md shadow-sm placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-0 focus:ring-gray-500 focus:border-gray-500 transition-colors"
